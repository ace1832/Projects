  ...
  <div class="row" align="center">
	...
	<div class="row">
		...
		<div class="large-12 columns">
			...
			<div class="panel">
				<h2>Edit Quantity for ItemID <?php echo $itemid ?> </h2>
				<h6>Edit Quantity for MarketID <?php echo $_SESSION["MARKETID"] ?> </h4>
				<h6>Edit Quantity for RetailerID <?php echo $_SESSION["RETAILERID"] ?> </h4>
	...
	<form action="edit.php?productid=<?php echo $itemid?>" method="post">
				<div class="row">
